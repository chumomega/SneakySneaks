...
public class DatabaseLoader implements CommandLineRunner {
	...
	@Autowired
	public DatabaseLoader(SneakerRepository sneakerRepo) {
		//SneakyUserRepository userRepo, 
		// removed the above line from the parameter list of this method
...
//		
		this.sneakerRepo.save(new Sneaker ("Nike", "Travis Scott Air Force One", 9, 130,"la flame travis scott joints", "link is here"));
		this.sneakerRepo.save(new Sneaker ("Adidas", "Triple White UltraBoost", 13, 180, "the og freshman year sneaker", "sdgr"));
		this.sneakerRepo.save(new Sneaker ("Adidas", "Bronze Raf Simons Stan Smiths", 7, 120, "oh you fancy huh", "rfdsv"));
...
//		
		...
		this.sneakerRepo.save(new Sneaker ("Reebok", "Vetements Instapump fury", 9, 150, "shouts to my son kareem for recommending these", "reg"));
		this.sneakerRepo.save(new Sneaker ("Nike", "Off-White Air Force One", 9, 150, "this nigga sulaiman really baited on this", "rgefgv"));
		this.sneakerRepo.save(new Sneaker ("Nike", "Off-White Air Force One", 11, 150, "so fire we had to put it twice", "fvdsv"));
...
//		
		this.sneakerRepo.save(new Sneaker ("Nike", "Off-White Air Force One", 11, 150, "glllltlttttt", "fdvffvd"));
		this.sneakerRepo.save(new Sneaker ("Adidas", "Yeezy Supermoon Yellow", 7, 220, "yeezy yeezy yeezy", "rfresg"));
